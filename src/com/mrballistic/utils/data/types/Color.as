package com.mrballistic.utils.data.types {

	import com.mrballistic.utils.MathHelper;
	...
	public class Color {
		...
		*/
		...
		public function set r(__value:Number):void	{ _r = MathHelper.Clamp(__value, 0, 255); } // { _r = value & 0xff; }
		
		public function get g(): Number				{ return _g; }
		public function set g(__value:Number):void	{ _g = MathHelper.Clamp(__value, 0, 255); }
		
		public function get b(): Number				{ return _b; }
		public function set b(__value:Number):void	{ _b = MathHelper.Clamp(__value, 0, 255); }
		
		public function get a(): Number				{ return _a; }
		public function set a(__value:Number):void	{ _a = MathHelper.Clamp(__value, 0, 255); }
		...
		public function set h(__value:Number): void {
			// Set Hue (0-360)
			_h = MathHelper.rangeMod(__value, 0, 360);
			setHSV(_h, s, v);
		}
		...
		public function set s(__value:Number): void {
			...
			setHSV(h, MathHelper.Clamp(__value), v);
		}
		...
		public function set v(__value:Number): void {
			// Set lightness (0-1)
			setHSV(h, s, MathHelper.Clamp(__value));
		}
		...
		public function get h(): Number {
		// Return Hue (0-360)
		var __r:Number = MathHelper.map(_r, 0, 255);
		var __g:Number = MathHelper.map(_g, 0, 255);
		var __b:Number = MathHelper.map(_b, 0, 255);
		...
		public function set h(__value:Number): void {
		// Set Hue (0-360)
		_h = MathHelper.roundClamp(__value, 0, 360);
		setHSL(_h, s, l);
		}
		...
		setHSL(h, MathHelper.clamp(__value), l);
		}
		...
		// Set lightness (0-1)
		setHSL(h, s, MathHelper.clamp(__value));
		}
		*/
